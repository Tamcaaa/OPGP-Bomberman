...
class Bomb(pygame.sprite.Sprite):
    def __init__(self, player, bomb_group, explosion_group, test_field):
        ...
        self.image = pygame.image.load("assets/player_items/bomb.png").convert_alpha()
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y, explosion_group, explosion_range, test_field):
        ...
        self.image_a = pygame.image.load("assets/player_items/explosion_a.png").convert_alpha()
        self.image_c = pygame.image.load("assets/player_items/explosion_c.png").convert_alpha()
