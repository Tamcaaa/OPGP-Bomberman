...
class PowerUp(pygame.sprite.Sprite):
    ...
    def apply_effect(self, player):
        ...
        if self.type == "bomb_powerup":
            ...
            player.power += 1  # Increase explosion range
            player.active_powerups["speed_powerup"] = now + self.effect_duration
            ...
            player.invincible_timer = now + self.effect_duration
            player.active_powerups["shield_powerup"] = now + self.effect_duration
