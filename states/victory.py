...
class Victory(State):
    def __init__(self, game):
        ...
        pygame.display.set_caption("BomberMan: Victory")
        self.bg_image = pygame.image.load(os.path.join(game.photos_dir, "bg.png"))


        # Create buttons
        self.next_button = Button(config.SCREEN_WIDTH // 2 - config.BUTTON_WIDTH - 20,
    ...
    def load_music(self):
        self.music_manager.play_music('win', 'win_volume', True)
    ...
    def render(self, screen):
        ...
        self.game.draw_text(screen, "You WON!", config.COLOR_BLACK, config.SCREEN_WIDTH // 2, config.SCREEN_HEIGHT // 4)
