...
class TestField(State):
    ...
    def render(self, screen):
        ...
        if self.player1 and not self.player1.is_dead and pygame.sprite.spritecollideany(self.player1, self.explosion_group):
            self.player1.hit_by_explosion()
    
        if self.player2 and not self.player2.is_dead and pygame.sprite.spritecollideany(self.player2, self.explosion_group):
